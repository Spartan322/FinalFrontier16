...
surface.CreateFont( "DefaultUnderline", {
font = "Tahoma",
size = 13,
weight = 500,
underline = true,
...
surface.CreateFont( "DefaultVerySmall", {
font = "Tahoma",
size = 10,
weight = 0,
} )
...
surface.CreateFont( "CenterPrintText", {
font = "Trebuchet MS",
size = 18,
weight = 900,
antialias = true,
...
surface.CreateFont( "DefaultFixed", {
font = "Lucida Console",
size = 10,
weight = 0,
} )

surface.CreateFont( "DefaultFixedDropShadow", {
font = "Lucida Console",
size = 10,
weight = 0,
shadow = true,
...
surface.CreateFont( "CloseCaption_Normal", {
font = "Tahoma",
size = 16,
weight = 500,
} )

surface.CreateFont( "CloseCaption_Italic", {
font = "Tahoma",
size = 16,
weight = 500,
italic = true,
...
surface.CreateFont( "CloseCaption_Bold", {
font = "Tahoma",
size = 16,
weight = 900,
} )

surface.CreateFont( "CloseCaption_BoldItalic", {
font = "Tahoma",
size = 16,
weight = 900,
italic = true,
...
surface.CreateFont( "BudgetLabel", {
font = "Courier New",
size = 14,
weight = 400,
outline = true,
...
-- cam -1581.458496 -396.353424 222.742065setang 0.340060 89.003883 0.000000
